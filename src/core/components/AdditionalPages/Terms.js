        ...
        <div className="bgcolora">
          ...
          <div className="bgarea" style={{ "max-width": "1120px" }}>
            <p className="beautify">
              Welcome to Fab Store, this page explains our terms of use. When
              you use the Fab Store, you’re agreeing to all the rules on this
            ...
            <p className="beautify">
              To sign up for a Fab Store account, you need to be 18 or over.
              You’re responsible for your account and all the activity on it.
              You can browse Fab Store without registering for an account. But
            ...
            <p className="beautify">
              Thousands of people use the Fab Store. We expect all of you to
              behave responsibly and help keep this a nice place. If you want be
              a part of this don’t do any of these things on our site:
              <br />
              ...
              illegal, violate any of Fab Store's policies, rules, or
              guidelines, or violate any applicable law, statute, ordinance, or
              regulation.
              <br />
              - Don’t victimize anyone. Don’t do anything threatening, abusive,
              harassing, defamatory, libelous, tortious, obscene, profane, or
              ...
              <br />
              - Don’t abuse other users’ personal information. When you use Fab
              Store — and especially if you create a successful store — you may
              receive information about other users, including things like their
              names, email addresses, and postal addresses. This information is
              provided for the purpose of participating in Fab Store: don’t use
              it for other purposes, and don’t abuse it.
              <br />
              - Don't post anything that is - is unlawful, threatening, abusive,
              harassing, defamatory, libelous, deceptive, fraudulent, invasive
              of another’s privacy, tortious, obscene, vulgar, pornographic,
            ...
            <p className="beautify">
              Fab Store is not and should not be held liable for any damages or
              losses related to your use of the Services. We don’t become
              involved in disputes between users, or between users and any third
              party relating to the use of the Services. We don’t oversee the
              performance or punctuality of pages and contents, and we don’t
              endorse any content users submit to the Site. When you use the
              Services, you release Fab Store from claims, damages, and demands
              of every kind — known or unknown, suspected or unsuspected,
              disclosed or undisclosed — arising out of or in any way related to
              such disputes and the Services. All content you access through the
              Services is at your own risk. You’re solely responsible for any
              resulting damage or loss to any party.
            </p>
            <h3>About our fees</h3>
            <p className="beautify">
              Creating an account on Fab Store is free. If you create a store
              that is successfully supported, we (and our payment partners)
              collect fees. Our partners’ fees may vary slightly based on your
              location. Each payment provider is its own company, and Fab Store
              isn’t responsible for its performance. You’re responsible for
              paying any additional fees or taxes associated with your use of
              Fab Store. You will be paid your margins on Wednesday of every
              week if it is greater than Rs.100.
            </p>
            <h3>About other websites and links</h3>
            <p className="beautify">
              Fab Store may contain links to other websites. (For instance, user
              websites pages, user profiles, and comments that may link to other
              sites.) When you access third-party websites, you do so at your
              own risk. We don’t control or endorse those sites. Fab Store
              partners with other companies (such as Cashfree) for payment
              processing. When you support or create a page, you’re also
              agreeing to the payment processor’s terms of service.
            </p>
            <h3>Our Intellectual Property</h3>
            <p className="beautify">
              - Fab Store’s services, content and Marks, are legally protected
              in a number of ways, including pursuant to copyright, trademark,
              service marks, patent, trade secrets, and other U.S. and
              international intellectual-property laws.
              <br />
              - You agree to respect all copyright and other legal notices,
              information, and restrictions contained in any Fab Store Content,
              Services, or Marks accessed through the Site or the Services.
              <br />
              - You agree not to change, translate, or otherwise create
              derivative works of the Services.
              <br />
              - Fab Store grants you a limited license (that is temporary,
              non-exclusive, non-sub-licensable, and non-Transferable) to access
              and use User Content and Fab Store’s Content solely for use of the
              ...
              User Content or Fab Store Content unless We give you express
              written permission to do so.
              <br />
              - We reserve the right to revoke this limited license to access
              and use User Content and Fab Store Content at any time and in our
              sole discretion.
              <br />
            </p>
            ...
            <p className="beautify">
              ...
              responsibility. You will pay all royalties and other amounts owed
              to any person or entity based on your Content, or on Fab Store’s
              ...
              <br />
              - We’re not responsible for mistakes in your content. Fab Store
            ...
            <p className="beautify">
              ...
              automatically remove the page from the Site.)
            </p>
            <h3>About indemnity</h3>
            <p className="beautify">
              You agree to defend, indemnify and hold harmless Fab Store, Our
              subsidiaries and affiliated companies, and Our officers,
              ...
              control of any matter for which you have agreed to indemnify us
              and you agree to assist and cooperate with us as reasonably
            ...
            <p className="beautify">
              ...
              infringement. Fab Store complies with the DMCA, and we respond to
              notices of alleged infringement if they comply with the law and
              the requirements set forth in our Copyright Policy. We reserve the
              right to delete or disable content alleged to be infringing, and
              to terminate accounts for repeat infringers. (We do this when
              appropriate and at our sole discretion.)
            </p>
            <h3>Agreement Between You and Us</h3>
            <p className="beautify">
              These Terms are the entire agreement between You and Fab Store
              with respect to the Services. They supersede all other
              communications and proposals (whether oral, written, or
              electronic) between you and Fab Store with respect to the Services
              and govern our relationship. If any provision of these Terms are
              ...
              force and effect. Fab Store's failure to assert any right or
            ...
            <p className="beautify">
              ...
              discretion. You agree that, except as otherwise expressly provided
              in these Terms, there shall be no third-party beneficiaries to
              these Terms. No waiver of any provision of these Terms shall be
              deemed a further or continuing waiver of such term or any other
              term, and Fab Store’s failure to assert any right or provision
              under these Terms shall not constitute a waiver of such right or
              provision. You agree that regardless of any statute or law to the
              contrary, any claim arising out of or related to the Services must
